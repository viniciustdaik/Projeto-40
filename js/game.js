class Game{
    ...
    player2 = createSprite(width - 220, 500);
    ...
    play(){
                ...
                player.getPlayerAtEnd();
                 image(back_img, 0, 0, width, height);//back_img, 0, 0, 1000, 800
                 var x =100;
                 var y=200;
                 var index =0;
                 drawSprites();
                 for(var plr in allPlayers){
                     ...
                     if(index === player.index){
                        ...
                        //text(""+players[index - 1].name, players[index - 1].x - 50, players[index - 1].y);
                         pop();
                     }
...
gameOver() {
 ...
 pop();
 //displayWidth / 2 - 400, displayHeight / 2 - 200
    }
